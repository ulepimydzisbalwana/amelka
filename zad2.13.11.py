...
library1 = Library("Bytom", "Dworcowa", "12345", "9:00  - 17:00", "123-456-789")
library2 = Library("Zabrze", "3 Maja", "54321", "10:00 - 16:00", "987-654-321")

employee1 = Employee("Jan", "Kowalski", "2022-01-01", "1990-01-01", "Katowice", "Francuska", "12345", "111-222-333")
employee2 = Employee("Marek", "Nowak", "2022-01-02", "1995-02-15", "Warszawa", "Wrocławska", "54321", "444-555-666")
employee3 = Employee("Justyna", "Kowalska", "2022-01-03", "1985-07-10", "Gdańsk", "Sądowa", "12345", "777-888-999")
